# ==========================================================
# 🔒 All Rights Reserved © Team GrayBots
# 📁 This file is part of the GrayBots Project.
# ==========================================================
...
from GrayBots.misc import SUDOERS
...
from GrayBots.utils.inline import botplaylist_markup
            ...
            if message.sender_chat:
                return await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[InlineKeyboardButton(text="ʕᵒˡ ᴛʏ ꟾɪʏ ?", callback_data="AudifymousAdmin")]]
                    )
                )
