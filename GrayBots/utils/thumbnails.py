...
async def get_thumb(videoid: str):
    ...
    try:
        ...
        icons = Image.open("GrayBots/assets/icons.png")
        ...
        font_info = ImageFont.truetype("GrayBots/assets/font2.ttf", 28)
        font_time = ImageFont.truetype("GrayBots/assets/font2.ttf", 26)
        font_path = "GrayBots/assets/font3.ttf"
        ...
        watermark_font = ImageFont.truetype("GrayBots/assets/font2.ttf", 24)
        watermark_text = "Team GrayBots"
